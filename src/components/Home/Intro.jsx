                ...
                <div className="row">
                    ...
                    {/* border border-2  */}
                        <div className="p-2 rounded intro-sm-container">
                            ...
                            <div className="mb-4">
                                ...
                                <h4 className="app-color">Software Developer | Agile Practitioner</h4>
                            </div>
                    ...
                    <div className="col-6 col-sm-5 col-md-6 col-lg-7 position-relative intro-lg">
                        <div className="intro-message">
                            <h1>Hi, I'm Solomon Fidelis</h1>
                            <h4>a <b className="app-color">Software Developer</b> | <b className="app-color">Agile Practitioner</b>.</h4>
                            <div className="mt-4">
                                <a href="#about" className="btn rounded-pill read-about-me app-btn-color-outline pe-4 ps-4">Read about me</a>
                            </div>
                        </div>
                    ...
                    <div className="col-6 col-sm-7 col-md-6 col-lg-5 intro-img-container intro-lg">
                        <img className="w-100 img-fluid" src="/imgs/dp 1.jpeg" alt="solomon fidelis" /> 
                    </div>
                </div>
            </div>
        </div>
